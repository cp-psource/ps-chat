...
- Added Dashboard Chat Friends Widget. Lets WordPress users see their friends online status. Works on Site and Network Dashboard widget area. Can be hidden by WordPress user role. Users can also hide this from display via their profile.  Requires PSOURCE Friends plugin or BuddyPress Friends option enabled. Can initiate private chat with online and available friends via widget.
- Added chat Status Widget for front-end. Lets WordPress users control thier Chat status.
- Added new Friends widget. Shows friends online. Works with either PSOURCE Friends plugin or BuddyPress Friends option enabled. Can initiate private chat with online and available friends via widget. 
...
- Removed some debug console.log output shown in psource-chat.js
...
* Corrected logic when using Facebook authentication only for bottom corner chat and not for inline chat. Which was causing endless refresh of page http://premium.psource.org/forums/topic/psource-chat-endlessly-refreshes-for-facebook
* Renamed global plugin instance from $chat to $psource_chat. https://app.asana.com/0/589152284006/1796940364279
* Added Chat Widget with some of the options. http://premium.psource.org/forums/topic/chat-box-as-a-widget-instead-of-floating
* Added support for moderator to delete/undelete messages http://premium.psource.org/forums/topic/moderate-chat-ban-users-delete-messages
...
* Corrected issue where depending on the WordPress setup the trailing slash is removed from the base URL. Causing sound manager to not load. http://premium.psource.org/forums/topic/soundmanager2swf-404-chat-plugin
* Added some color options for Row area background, Row item background, Row item border width, Row item border color. http://premium.psource.org/forums/topic/moderate-chat-ban-users-delete-messages
