...
if ( ! class_exists( 'PSOURCE_Chat' ) ) {
	class PSOURCE_Chat {
		var $chat_current_version = '2.4.0';
		...
		function __construct() {
			...
			$this->_chat_plugin_settings['config_file']    = dirname( __FILE__ ) . '/psource-chat-config.php';
...
//			add_action( 'wp_login', array( &$this, 'unset_cookies' ), 99, 2 );
		...
		function admin_enqueue_scripts() {
			...
			wp_register_style( 'psource-chat-style', plugins_url( '/css/psource-chat-style.css', __FILE__ ), array(), $this->chat_current_version );
			wp_register_style( 'psource-chat-jquery-ui-datepicker-css', $css_url, false, '1.0.0' );

			//Admin Styles
			wp_register_style( 'psource-chat-wpadminbar-style', plugins_url( '/css/psource-chat-wpadminbar.css', __FILE__ ), array(), $this->chat_current_version );
			wp_register_style( 'psource-chat-admin-css', plugins_url( '/css/psource-chat-admin.css', __FILE__ ), array(), $this->chat_current_version );

			if ( ! version_compare( $wp_version, '3.7.1', '>' ) ) {
				wp_register_style( 'psource-chat-wpadminbar-style-pre-38', plugins_url( '/css/psource-chat-wpadminbar-pre-38.css', __FILE__ ), array(), $this->chat_current_version );
			}
			...
			wp_register_script( 'psource-chat-admin-js', plugins_url( '/js/psource-chat-admin.js', __FILE__ ), array(
				'jquery',
				'jquery-ui-core',
				'jquery-ui-tabs'
			...
			wp_register_script( 'psource-chat-js', plugins_url( '/js/psource-chat.js', __FILE__ ), array( 'jquery' ), $this->chat_current_version, true );
		...
		function tinymce_options() {
			...
			wp_register_style( 'psource-chat-admin-css', plugins_url( '/css/psource-chat-admin.css', __FILE__ ),
			...
			wp_enqueue_script( 'psource-chat-admin-js', plugins_url( '/js/psource-chat-admin.js', __FILE__ ), array( 'jquery' ), $this->chat_current_version, true );
			$this->_registered_scripts['psource-chat-admin-js'] = 'psource-chat-admin-js';

			wp_enqueue_script( 'psource-chat-admin-tinymce-js', plugins_url( '/js/psource-chat-admin-tinymce.js', __FILE__ ),
			...
			wp_enqueue_script( 'psource-chat-admin-farbtastic-js', plugins_url( '/js/psource-chat-admin-farbtastic.js', __FILE__ ), array(
				'jquery',
				'farbtastic'
